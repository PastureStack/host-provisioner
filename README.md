...
Vendored dependencies are recorded in `trash.yml` with semantic-version tags or complete upstream commit IDs. Validation rejects abbreviated commit IDs so dependency provenance remains unambiguous.
